...
Binomial Tree (Excel): 
This was made to price American options for the S&P 100 index. I used OEX, XEO and VIX data from the Chicago Board Options Exchange, the dividend yield comes from Bloomberg. The time to maturity is represented in years. For this example I used a 42 day maturity.
